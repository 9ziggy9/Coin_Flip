        ...
        <div className="landing-top">
          <div className="landing-top-left">
            ...
            <p className="landing-top-desc">
              Simulated investing, plus the tools you need to prepare yourself for investing in cryptocurrency. Sign up and get started for free. Certain
              limitations apply.
            </p>
            <div className="landing-signup">
              <div className="landing-signup-left">
                <p className="landing-signup-btn">Sign Up</p>
              </div>
