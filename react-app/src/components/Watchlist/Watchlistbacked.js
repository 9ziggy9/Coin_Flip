...
const Watchlist = () => {
  ...
  const displayControl = (e, w) => {
    setW(w)
    const menu = e.target.getBoundingClientRect();
    const dropdown = document.querySelector(".watchlist-dropdown")
    dropdown.style.position = "absolute";
    dropdown.style.left = `${menu.left}px`
    dropdown.style.top = `${menu.top}px`
  };
    ...
    <div
        ...
        >
          <div className={`list-drp-main list-drop-${w?.id}`}>
            ...
            >
              <img className="list-settings-img" src={imgUrl} /> Edit list
            </div>
            <div
            ...
            >
              <img className="list-settings-img" src={delUrl} /> Delete list
            </div>
          </div>
          <div className={`edit-watchlist-main edit-${w?.id} hidden`}>
            <input
              className="watchlist-edit-input"
              onKeyPress={(e) => e.key === "Enter" && editListName(w?.id)}
              value={editInput}
          ...
          >
            ...
            <div className="list-del-btns">
              <button className="list-del-yes" onClick={() => delList(w?.id)}>
                Yes
              </button>
              <button
                ...
                <div className="watchlist-details-right">
                  <div className="watchlist-options-fill">
                    <div
                      ...
                      onMouseDown={(e) => displayControl(e, w)}
                    >
                      ...
                    </div>
                  </div>
